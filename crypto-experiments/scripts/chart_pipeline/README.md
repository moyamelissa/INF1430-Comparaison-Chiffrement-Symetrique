...
|---|---|---|
| Débit de chiffrement en fonction de l'algorithme et du mode (x86 uniquement) | `01-debit/debit-40960-x86.png` | `python -c "import sys; sys.path.insert(0, 'scripts'); from chart_pipeline import build_performance as b; b.fig1_throughput_4096()"` |
| Débit de chiffrement en fonction de l'algorithme et du mode (Raspberry Pi uniquement) | `01-debit/debit-40960-pi.png` | `python -c "import sys; sys.path.insert(0, 'scripts'); from chart_pipeline import build_platform_comparison as b; b.cmp1b_throughput_4096_pi()"` |
...
| Débit selon la taille du message (x86 vs ARM, ECB forcé) | `01-debit/comparaison-debit-vs-taille-message.png` | `python -c "import sys; sys.path.insert(0, 'scripts'); from chart_pipeline import build_platform_comparison as b; b.cmp3_throughput_vs_size()"` |
...
| Débit selon la taille du message (x86 vs ARM, tous algorithmes dont ChaCha20) | `01-debit/comparaison-debit-vs-taille-message-all-algorithms.png` | `python -c "import sys; sys.path.insert(0, 'scripts'); from chart_pipeline import build_platform_comparison as b; b.cmp8_scalability_all_algos()"` |
