...
Ce coefficient s'applique quand $n \ge 30$, car à partir de cette valeur, la distribution de la moyenne échantillonnale converge vers une loi normale (théorème central limite). Pour $n < 30$, on utilise la distribution de Student avec $n-1$ degrés de liberté.
