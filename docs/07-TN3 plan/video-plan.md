...
4. **Vidéo 4 — AES: architecture et écarts (pages 7-10)**
   ...
   - Appui: résultats de **crypto-experiments/scripts/charts/render_platform_comparison.py**

5. **Vidéo 5 — ChaCha20 et ARM/x86 (pages 11-13)**
   - Fichier principal: **crypto-experiments/domain/cipher/ChaCha20.py**
   - Appui: **crypto-experiments/scripts/charts/render_platform_comparison.py**
...
6. **Vidéo 6 — Algorithmes hérités et modes (pages 14-15)**
   ...
   - Appui: **crypto-experiments/validation/kat_modes.py**, **crypto-experiments/scripts/charts/render_ecb_demo.py**
...
7. **Vidéo 7 — Robustesse et stabilité statistique (pages 16-18)**
   ...
   - Appui: **crypto-experiments/scripts/charts/render_avalanche_rounds.py**
...
8. **Vidéo 8 — Synthèse et recommandations (pages 19-22)**
   - Fichier principal: **crypto-experiments/scripts/charts/render_platform_comparison.py**
...
1. **Effet d'avalanche selon le nombre de tours**
   ...
   - Fichiers/preuves: **scripts/charts/render_avalanche_rounds.py** + figure rounds vs avalanche.
...
3. **Synthèse traçable par fichiers**
   ...
   - Fichiers/preuves: **scripts/charts/render_platform_comparison.py** + CSV x86/Pi + graphiques générés.
...
6. **crypto-experiments/scripts/charts/render_platform_comparison.py**
