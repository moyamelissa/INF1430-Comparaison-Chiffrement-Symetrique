...
## Portee
- scripts/charts/render_avalanche_rounds.py
- Execution terminal
...
#### Etape 1
**Action ecran :**
Ouvrir scripts/charts/render_avalanche_rounds.py.
...
(PAUSE) (SURLIGNER: **scripts/charts/render_avalanche_rounds.py**) (SURLIGNER: **mesures d avalanche**)
...
#### Etape 3
**Action ecran :**
Executer python scripts/charts/render_avalanche_rounds.py.
